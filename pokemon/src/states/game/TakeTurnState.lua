...
function TakeTurnState:victory()
    ...
    :finish(function()
        ...
        function()
            ...
            local exp = 10 * (self.opponentPokemon.HPIV + self.opponentPokemon.attackIV +
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local msg = 'Congratulations! Level Up!\n' ..
                        'HP: ' .. self.playerPokemon.HP - HPIncrease .. ' + ' .. HPIncrease .. ' = ' .. self.playerPokemon.HP .. '\n' ..
                        'ATK: ' .. self.playerPokemon.attack - attackIncrease .. ' + ' .. attackIncrease .. ' = ' .. self.playerPokemon.attack .. '\n' ..
                        'DEF: ' .. self.playerPokemon.defense - defenseIncrease .. ' + ' .. defenseIncrease .. ' = ' .. self.playerPokemon.defense .. '\n' ..
                        'SPD: ' .. self.playerPokemon.speed - speedIncrease .. ' + ' .. speedIncrease .. ' = ' .. self.playerPokemon.speed .. '\n'

                        gStateStack:push(BattleMessageState(msg,function()   
                            self:fadeOutWhite()
                        end))
                    else
                        self:fadeOutWhite()
