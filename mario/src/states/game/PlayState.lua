...
function PlayState:enter(params)
    ...
    self.width = params.width == 40 and params.width or params.width + 10
    ...
    for x=1, self.tileMap.width do 
        local isEmpty = true -- assuming this column is empty
    ...
    -- self.player.score = params.score == 0 and 0 or params.score
...
function PlayState:update(dt)
    ...
    if self.player.winCon == true then
...
function PlayState:render()
    ...
    -- printing width for debug purposes
    --love.graphics.print(tostring(self.width), 15, 15)
end
