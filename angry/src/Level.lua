...
function Level:init()
    ...
    function beginContact(a, b, coll)
        ...
        if types['Obstacle'] and types['Player'] then
            ...
            self.launchMarker.alien[1].collided = true
...
function Level:update(dt)
    ...
    if self.launchMarker.launched then
        local xPos, yPos = self.launchMarker.alien[1].body:getPosition()
        local xVel, yVel = self.launchMarker.alien[1].body:getLinearVelocity()
