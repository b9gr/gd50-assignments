...
function love.update(dt)
    ...
    -- player 1 movement
    if ball.y - player1.y < 0 then 
        player1.dy = -PADDLE_SPEED
    elseif (ball.y + ball.height) - (player1.y + player1.height) > 0 then
        player1.dy = PADDLE_SPEED
    else
        player1.dy = 0
    end
    ...
    -- player 2 movement
    if ball.y - player2.y < 0 then 
        player2.dy = -PADDLE_SPEED
    elseif (ball.y + ball.height) - (player2.y + player2.height) > 0 then
        player2.dy = PADDLE_SPEED
    else
        player2.dy = 0
    end
